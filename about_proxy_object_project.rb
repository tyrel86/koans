...
class Proxy
  ...
  def initialize(target_object)
    @object = target_object
		@times_for_message_hash = {}
		@times_for_message_hash.default = 0
    @messages = []
  end

	def method_missing( method_name, *args, &block )
		@messages << method_name
		if @times_for_message_hash.has_key? method_name
			@times_for_message_hash[method_name.to_sym] += 1
		else
			@times_for_message_hash[method_name.to_sym] = 1
		end
	...
	def number_of_times_called( method_name )
		@times_for_message_hash[method_name.to_sym]
	end
end
